...
/**
 * RequestCard component to display a connection request card
 * Shows user information and action buttons (Accept/Reject)
 * @param {Object} props - Component props
 * @param {Object} props.request - Connection request object containing user data
 * @param {Function} props.onAccept - Callback function when accept button is clicked
 * @param {Function} props.onReject - Callback function when reject button is clicked
